...
\todo{Afschrijven relevantie}
\begin{itemize}
    \item Eerste medium dat klinkend geluid draagt
    \item Muziek toegankelijker voor brede publiek
\end{itemize}
...
\todo{Schrijven relevantie NichePlayer}
\begin{itemize}
    \item Waarom wordt het nog steeds gebruikt?
    \item Fysieke massa verkoop
    \item Verzamelobject
    \item Standaarden forceren door technische beperkingen
\end{itemize}
...
Cassettes zijn interessant voor de NichePlayer vanwege hun effect op de cultuur van muziek. Het is een medium dat makkelijk te verspreiden is en waarop mensen zelf muziek kunnen opnemen.

\todo{Samenvatten relevantie}

% - [ ] Kopiëren (met kwaliteitsverlies)
% - [x] Nieuwe Cultuur, Mixtapes
% - [x] Opnemen vanuit andere media zoals radio (piracy!)
% - [x] Portable
...
Tijdens het ontwikkelen van de NichePlayer moet ik constant in de gate houden dat het niet te veel op TapTapes gaat lijken. \todo{Aanvullen}
